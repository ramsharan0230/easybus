                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{asset('backend/assets/images/user2-160x160.jpg')}}" class="user-image" alt="User Image">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="{{route('addAssistant')}}"><i class="fa fa-plus"></i>Add Assestant
                               <!--  <span class="pull-right-container">
                                    <span class="label label-info pull-right">2</span>
                                </span> -->
                            </a>
                        ...
                        <li>
                            <a href="{{route('allAssistant')}}"><i class="fa fa-eye"></i> Assestant List
                                <span class="pull-right-container">

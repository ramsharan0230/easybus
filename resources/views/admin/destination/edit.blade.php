                ...
                <div class="row equal_height">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body ">
                                <form action="{{route('destination.update',$detail->id)}}" method="post">
                                    {{csrf_field()}}
                               ...
                               <div class="row equal_height form-group">
                                    <div class="col-lg-12 col-sm-12 col-xs-12 m_b20">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name" id="conter_name" class="form-control"   placeholder="Ex. Kathmandu" value="{{$detail->name}}">
                                        </div>
                                    </div>

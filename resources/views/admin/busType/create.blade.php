...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-5">
            <form method="post" action="{{route('bus-type.store')}}" enctype="multipart/form-data">
            {{csrf_field()}}
    ...
    <div class="col-md-7">
        <div class="box box-warning">
            <div class="box-header with-heading">
                <h3 class="box-title">Categories (Total = {{$categories->count()}})</h3>
            </div>
                ...
                <table id="example1" class="table vendor-table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn vendor-busses edit" href="{{route('bus-type.show',$detail->id)}}" title="Edit">Vehicle List</a>

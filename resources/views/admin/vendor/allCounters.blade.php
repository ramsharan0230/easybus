                                ...
                                <table id="example1" class="table vendor-table responsive table-hover dt-responsive nowrap bulk_action" >
                                    ...
                                    <tbody class="text-uppercase">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('vendors_counter_view',$counter->id)}}" class="btn vendor-busses"> <span class="fa fa-edit"></span> View</a>
                                                <a href="{{route('ticketSale',$counter->id)}}" class="btn vendor-busses"> <span class="fa fa-edit"></span>Ticket Sale</a>
                                                <a href="{{route('approvedBus',$counter->id)}}" class="btn vendor-busses"> <span class="fa fa-edit"></span>Approved Bus</a>

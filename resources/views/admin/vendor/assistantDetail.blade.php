...
@section('title','Assistant Detail')
@section('content')
<!-- Content Header (Page header) -->
            <section class="content-header">
                <h1>Assestant Detail<small>EASYBUS</small></h1>
                <ol class="breadcrumb">
                    <li><a href="./"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li><a href="{{route('allAssistant')}}">All Assestant</a></li>
                    <li class="active">Assestant Detail</li>
                </ol>
            </section>
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                    <a href="{{route('allAssistant')}}" class="btn btn-success">All Assistant</a>
                                </div>
                            </div>
                                        ...
                                        <div class="row equal_height form-group"> 
                                            ...
                                            <div class="col-lg-6 col-sm-6 m_b20">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="phone" id="phone" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask='"mask": "(999) 999-9999"'  placeholder="Contact No" value="{{$data->phone}}" readonly="">
                                                </div>
                                            </div>
                                           ...
                                           <!--  <div class="col-lg-6 col-sm-6 m_b20">
                                            ...
                                            <div class="m_b20">
                                                <label class="font_25">Citizenship Front View</label>
                                            ...
                                            <div class="m_b20">
                                                <label class="font_25">Citizenship Back View</label>
                                            ...
                                            <div class="m_b20">
                                                ...
                                                <a href="{{asset('document/'.$data->driving_front)}}" target="_blank">
                                                    <img src="{{asset('document/'.$data->driving_front)}}" alt="" class="citizenship">
                                            ...
                                            <div class="m_b20">
                                                ...
                                                <a href="{{asset('document/'.$data->driving_back)}}" target="_blank">
                                                    <img src="{{asset('document/'.$data->driving_back)}}" alt="" class="citizenship">

...
<!-- Content Header (Page header) -->
            <section class="content-header">
                <h1>Vendor<small>EASYBUS</small></h1>
                <ol class="breadcrumb">
                        ...
                        <!-- <div class="box-tools pull-right">
                            ...
                            <div class="box-body ">
                                ...
                                @php
                                    $info=Auth::user();
                                @endphp
                                <form action="{{route('updateVendorInfo',$info->id)}}" class="form form-horizontal form-responsive" method="post" id="form" enctype="multipart/form-data">
                                    {{csrf_field()}}

                ...
                <form action="" class="form form-horizontal form-responsive" method="post" >
                    <div class="row equal_height">
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12 m_t20">
                            <div class="row equal_height">
                               <div class="col-md-6">
                                   <h2 class="bus-info-title">Bus Information</h2>
                                        <div class="box box-info bus-layout-wrapp-main">
                                                        ...
                                                        <tbody >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                	...
                                                                	@else
                                                                		@if(count($busseat)>0)
				                                                        <img src="{{asset('backend/assets/images/seat2.png')}}" class="seat_icon2 bus-layout-wrapp free_seat">

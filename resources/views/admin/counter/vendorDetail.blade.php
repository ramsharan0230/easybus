                        ...
                        <div class="box">
                            <div class="box-header with-border">
                               ...
                               <!--  <div class="box-tools pull-right">
                                    <a href="{{route('adminCounter')}}" class="btn btn-success">All Vendors</a>
                                </div> -->
                            </div>
                            <div class="box-body ">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m_b20">
                                                ...
                                                <a href="{{asset('images/document/'.$data->citizen_front)}}" target="_blank">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m_b20">
                                                ...
                                                <a href="{{asset('images/document/'.$data->citizen_back)}}" target="_blank">

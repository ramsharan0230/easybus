                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <a href="#" class="btn btn-success">All Admin</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row equal_height">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <div class="box-body ">
                                <form action="{{route('user.update',$detail->id)}}" class="form form-horizontal form-responsive" method="post" enctype="multipart/form-data" id="form">
                                    {{csrf_field()}}
                                    <input type="hidden" name="_method" value="PUT">
                                    <div class="row equal_height form-group">
                                        <div class="col-lg-12 col-sm-12 col-xs-12 m_b20">  
                                            <input type="text" name="name" id="name" class="form-control" placeholder="Admin Full Name" value="{{$detail->name}}">
                                        </div>
                                        <div class="col-lg-12 col-sm-12 col-xs-12 m_b20">

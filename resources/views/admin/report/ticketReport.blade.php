...
<script type="text/javascript">
    ...
    var weekly_ticket_total = <?php echo json_encode($weekly_ticket_total);?>;
    var monthly_ticket_total = <?php echo json_encode($monthly_ticket_total);?>;

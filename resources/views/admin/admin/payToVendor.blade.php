...
<!-- Content Header (Page header) -->
            ...
            <section class="content">
                ...
                <div class="row equal_height">
                    <div class="col-lg-12">
                        <!-- Default box -->
                        <div class="box hidden payBox">
                            <div class="box-header">
                                
                            </div>
                            <div class="box-body vendor-box">
                                <button class="btn btn-success pay-button">Mark As Paid</button>
                            </div>
                        </div>
                        <div class="box">
                                ...
                                <div class="row">   
                                    ...
                                    <div class="col-lg-2 col-md-3">
                                        ...
                                        <select class="form-control" name="vendor">
                                        	...
                                        	<option value="{{$vendor->id}}" {{$vendor->id==$searchedVendor?'selected':''}}>{{$vendor->name}}</option>
                                        	@endforeach
                                        </select>
                                        </div>
                                    </div>
                            ...
                            <div class="box-body vendor-box append_here">

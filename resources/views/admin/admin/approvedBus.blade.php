					...
					<table id="example1" class="table vendor-table table-striped">
                        ...
                        <tr>
				            ...
				            <td>
				            	...
				            	<a class="btn vendor-busses edit" href="#" title="Edit" disabled="true">Approved</a>
				            	<a class="btn vendor-busses edit" href="{{route('rejectBus',$detail->id)}}" title="Edit">Reject</a>
				            	<a class="btn vendor-busses edit" href="{{route('busAdvertisemet',$detail->id)}}" title="Edit">Advertisement</a>
				            	
				            	<a class="btn vendor-busses edit" href="{{route('approvedBusTicket',$detail->id)}}" title="Edit">Tickets</a>

    ...
    $("#okey").click(function(e){
        ...
        for (var i = 0; i < seat_row; i++){
            ...
            for(var j =0; j<seat_column; j++){
                rows.append('<td  data-seat='+i+j+' id='+i+j+'><input type="text" name="seat_name" id="seat_name'+i+j+'" class="form-control dropzone"></td>');
                $(function shortable(){
                    $( "#seat_method tr td" ).sortable({
                        revert: true,
                        connectWith: "#seat_method tr td",
                    ...
                    $( "#seat_method  tr td" ).droppable({
                        ...
                        over :function(event, ui) { 
                            ...
                            var seat_id = $(this).data('seat'); 
                            // console.log(seat_id);
                            droppedItemID = ui.draggable.data("id");
                            // $('#'+seat_id).append('<input type="text" name="row_col" id="commentvalue_'+seat_id+'">');
